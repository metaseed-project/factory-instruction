...
```
set ContractId=registry4.metaseed.testnet

set GD=game_creator1.testnet

set GAME_NAME=my_game_name
...
```
set NFT_PREFIX=super_sword_collection
...
```
set Receiver=phoneiostest.testnet

echo %NFT_PREFIX%.%GAME_NAME%.%ContractId%

near call %NFT_PREFIX%.%GAME_NAME%.%ContractId% nft_mint '{\"token_id\":\"2\",\"receiver_id\":\"%Receiver%\",\"token_metadata\":{\"title\":\"sword1\",\"description\":\"Super_rare_sword\",\"media\":\"https://bafkreifeih3hr6g5e3alrngb3rsrkvb7wwspibwreu6wagwwfietbboa6u.ipfs.dweb.link\",\"copies\":1}}' --accountId %GD% --deposit 0.1
```
